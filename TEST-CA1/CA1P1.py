...
#this is to test that the program works, and returns appropriate results
#Generate a AZ covidID and verify that it's correct (it is)
idOne = generateCovidId(1)
print(idOne)
print("ID:", idOne, "is", validateCovidId(idOne))
#Generate a MO covidID and verify that it's correct (it is)
idTwo = generateCovidId(2)
print(idTwo)
print("ID:", idTwo, "is", validateCovidId(idTwo))
#Generate a JA covidID and verify that it's correct (it is)
idThree = generateCovidId(3)
print(idThree)
print("ID:", idThree, "is", validateCovidId(idThree))
#Generate a PF covidID and verify that it's correct (it is)
idFour = generateCovidId(4)
print(idFour)
print("ID:", idFour, "is", validateCovidId(idFour))
#Generate a fake PF covidID and verify that it's correct (it's not)
idFive = "PF1234567"
print(idFive)
print("ID:", idFive, "is", validateCovidId(idFive))
#Generate a fake AA covidID and verify that it's correct (it's not)
idSix = "AA7654321"
print(idSix)
print("ID:", idSix, "is", validateCovidId(idSix))
#Generate a fake PF covidID and verify that it's correct (it's not)
idSeven = "PF76543210"
print(idSeven)
print("ID:", idSeven, "is", validateCovidId(idSeven))
